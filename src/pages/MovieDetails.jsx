            ...
            <div className="flex-1 text-white">
              <FadeInAnimation type="movieDetails">
                ...
                <div className="flex flex-wrap gap-4 mb-4 text-sm">
                  <span className="bg-green-600 px-3 py-1 rounded-full font-bold inline-flex items-center h-9">
                    {movie.release_date}
                  </span>
                  <span className="bg-blue-600 px-3 py-1 rounded-full font-bold inline-flex items-center h-9">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {movie.genres?.map((genre) => (
                    <span
                      key={genre.id}
                      className="border border-purple-400 text-purple-300 px-3 py-1 rounded-full text-sm"
                    >
                      {genre.name}
                    </span>
                  ))}
