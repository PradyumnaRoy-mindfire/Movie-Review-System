  ...
  const features = [
    {
      ...
      description:
        "Browse through thousands of movies with seamless infinite scroll. Never run out of content to explore.",
    },
    {
      icon: <Search className="w-8 h-8" />,
      title: "Smart Filtering",
      description:
        "Filter movies by genre, release year, rating, and more. Find exactly what you're in the mood for.",
    },
    {
      icon: <Heart className="w-8 h-8" />,
      title: "Favorites & Watchlist",
      description:
        "Mark movies as favorites and drag them to your watch later section. Your personalized cinema awaits.",
    },
    {
      icon: <Star className="w-8 h-8" />,
      title: "Detailed Reviews",
      description:
        "Access comprehensive movie information including budget, ratings, cast, and related videos.",
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "External Links",
      description:
        "Quick access to official movie websites and IMDb pages for deeper exploration.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Real-time Notifications",
      description:
        "Get instant feedback when adding or removing movies from your favorites.",
    },
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=1600&h=900&fit=crop')] bg-cover bg-center"></div>
          <FadeInAnimation type={"movieDetails"}>
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
                Discover, organize, and explore the world of cinema like never
                before. CineFlix brings you an immersive movie browsing
                experience.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-gradient-to-br from-purple-900 from-opacity-50 to-pink-900 to-opacity-50 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-purple-500 border-opacity-30">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              At CineFlix, we believe that discovering your next favorite movie
              should be an experience in itself. We've built a platform that
              combines powerful search capabilities, intelligent filtering, and
              personalized recommendations to help movie enthusiasts explore the
              vast world of cinema. Whether you're a casual viewer or a
              dedicated cinephile, our intuitive interface and comprehensive
              database make it easy to find, organize, and enjoy movies that
              match your taste.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <FadeInAnimation type={"movieDetails"}>
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                The People Behind CineFlix
              </h2>
              <p className="text-gray-400 text-lg">
                Passionate movie lovers building the future of film discovery
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <FadeInAnimation type={"movieDetails"}>
            <div className="relative overflow-hidden rounded-3xl">
              ...
              <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1600&h=600&fit=crop')] bg-cover bg-center"></div>
              ...
              <div className="relative px-8 py-16 text-center">
                ...
                <p className="text-lg mb-8 text-white text-opacity-90 max-w-2xl mx-auto">
                  Join thousands of movie enthusiasts who have already
                  discovered their next favorite film on CineFlix
                </p>
                <Link
                  to="/"
